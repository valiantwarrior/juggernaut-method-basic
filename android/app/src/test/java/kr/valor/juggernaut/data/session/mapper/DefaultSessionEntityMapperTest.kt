...
class DefaultSessionEntityMapperTest {
    ...
    private lateinit var mapper: SessionMapper<SessionEntity, Session, SessionRecord>
    ...
    fun `init`() {
        ...
        accumulationSessionEntity = SessionEntity(
            ...
            baseWeights = 60,
            amrapRepetitions = 10,
            completeDateMillis = System.currentTimeMillis()
        )
...
//            assertThat(sessionModel.tmWeights, `is`(baseWeights))
